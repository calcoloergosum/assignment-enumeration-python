...
builtins.__KBEST_ASSIGNMENT_SETUP__ = True
...
def get_version_info():
    ...
    elif os.path.exists('src/kbest_assignment/version.py'):
        # must be a source distribution, use existing version file
        # load it as a separate module to not load scipy/__init__.py
        import runpy
        ns = runpy.run_path('src/kbest_assignment/version.py')
...
def write_version_py(filename='src/kbest_assignment/version.py'):
    cnt = """
# THIS FILE IS GENERATED FROM kbest assignment SETUP.PY
...
def configuration(parent_package='', top_path=None):
    ...
    config.add_subpackage('src/kbest_assignment')
    config.add_data_files(('kbest_assignment', '*.txt'))

    config.get_version('src/kbest_assignment/version.py')
...
def setup_package():
    ...
    metadata = dict(
        name='kbest_assignment',
        maintainer="Han Jaeseung",
        maintainer_email="thestudentofkyoto@gmail.com",
        description=DOCLINES[0],
        long_description="\n".join(DOCLINES[2:]),
        url="https://github.com/studentofkyoto/assignment-enumeration-python",
        download_url="https://github.com/studentofkyoto/assignment-enumeration-python/releases",
        project_urls={
            "Bug Tracker": "https://github.com/studentofkyoto/assignment-enumeration-python/issues",
            "Documentation": "https://_",
            "Source Code": "https://github.com/studentofkyoto/assignment-enumeration-python",
        },
        license='BSD',
        cmdclass=cmdclass,
